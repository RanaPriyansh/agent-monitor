...
Repository: https://github.com/RanaPriyansh/thielon-agent-monitor.git
Canonical local path: /root/git-repos/agent-monitor
Default branch: main
...
3. Run the local setup path for agent-monitor and write exact commands back into README if they are missing or stale.
